        ...
        <Animatable.View style={styles.footer} animation="fadeInUpBig">
          ...
          <View style={[styles.action, {marginTop: 40}]}>
            ...
            <TextInput
              ...
              onChangeText={text_userName =>
                this.checkNameValidation(text_userName)
              }
            />
          ...
          <View style={[styles.action, {marginTop: 20}]}>
            ...
            <TextInput
              ...
              style={styles.textInput}
              onChangeText={text_phoneNumber =>
                this.checkPhoneValidation(text_phoneNumber)
              }
            />
          ...
          <View style={[styles.action, {marginTop: 20}]}>
            ...
            <Animatable.View animation="bounceIn">
              <TouchableOpacity onPress={() => this.makeSecurePassword()}>
                {this.state.secureTextEntry ? (
